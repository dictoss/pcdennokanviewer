...
public class AsyncDiaryHttpJsonTask<T> extends AsyncHttpTask<T> {

	public AsyncDiaryHttpJsonTask(Activity a) {
		super(a);
	}
	...
	protected T convertResponse(InputStream is) throws UnsupportedEncodingException
	{
		...
		try{
			...
			data = mapper.readValue(br, DictossDiaryList.class);
		}
		catch(Exception e){
