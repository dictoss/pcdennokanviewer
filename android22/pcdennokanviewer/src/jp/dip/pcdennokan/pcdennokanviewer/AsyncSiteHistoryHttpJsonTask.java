...
public class AsyncSiteHistoryHttpJsonTask<T> extends AsyncHttpTask<T> {

	public AsyncSiteHistoryHttpJsonTask(Activity a) {
		super(a);
	}
	...
	protected T convertResponse(InputStream is) throws UnsupportedEncodingException
	{
		...
		DictossSiteHistoryList data = null;
		...
		try{
			...
			data = mapper.readValue(br, DictossSiteHistoryList.class);
		}
		catch(Exception e){
